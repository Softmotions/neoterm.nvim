...
function neoterm.open(opts)
  ...
  if win_is_open() ~= true then
    ...
    if position == 0 then -- fullscreen
      ...
      winopts.height = ui.height - vim.o.cmdheight - 1
      winopts.row = 0
      winopts.col = 0
    elseif position == 1 then -- top
      winopts.width = ui.width - width_padding
      winopts.height = math.floor(ui.height * height) - vim.o.cmdheight - 1
      winopts.row = 0
      winopts.col = 0
    ...
    elseif position == 3 then -- bottom
      winopts.width = ui.width - width_padding
      winopts.height = math.floor(ui.height * height) - vim.o.cmdheight - 1
      winopts.row = ui.height - winopts.height - vim.o.cmdheight - 1
      winopts.col = 0
